package com.exam.app.endpoint.event.consumer;

import com.exam.app.PojaGenerated;
import com.exam.app.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.exam.app.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.exam.app.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
