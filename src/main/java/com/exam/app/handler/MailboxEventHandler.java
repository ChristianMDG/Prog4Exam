package com.exam.app.handler;

import static com.exam.app.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.exam.app.PojaApplication;
import com.exam.app.PojaGenerated;
import com.exam.app.endpoint.EndpointConf;
import com.exam.app.endpoint.event.EventConf;
import com.exam.app.endpoint.event.consumer.EventConsumer;
import com.exam.app.endpoint.event.consumer.model.ConsumableEvent;
import com.exam.app.endpoint.event.consumer.model.ConsumableEventTyper;
